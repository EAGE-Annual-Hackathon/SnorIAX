...
def show_tensor_images(image_tensor, ax, num_images=15, vmin=-1, vmax=1, cbar=False, cmap='gray'):
    """Visualize images
    ...
    ax.axis('off')
    im = ax.imshow(image_grid[0].squeeze(), cmap=cmap, vmin=vmin, vmax=vmax)
    if cbar:
